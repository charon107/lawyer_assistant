"""Cold-start interview request / response schemas (ip-legal).
...
6-step depth-driven state machine:
    ...
    4 = seed files (portfolio export / letter templates / OSS policy / approval handbook)
    5 = output config + generate profile

Depth gates which steps run (see ip_cold_start_service):
    quick → (0, 1, 5)
    full  → (0, 1, 2, 3, 4, 5)
"""
